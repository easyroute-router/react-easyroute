...
var RouterOutlet = /** @class */ (function (_super) {
    ...
    function RouterOutlet(props, context) {
        ...
        _this.matchedSubscribe = function (matchedRoutes) { return __awaiter(_this, void 0, void 0, function () {
            var currentRoute, component, isClassComponent, Component_1;
            var _this = this;
            var _a;
            return __generator(this, function (_b) {
                ...
                if (currentRoute) {
                    ...
                    isClassComponent = !!((_a = component.prototype) === null || _a === void 0 ? void 0 : _a.render);
                    Component_1 = isClassComponent ? new component(this.componentProps) : component;
                    try {
                        // @TODO: lazy component loading
                        this.changeComponent(Component_1, isClassComponent, currentRoute.id);
                    }
                    catch (e) {
                        this.setState({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.setState({
                            component: isClassComponent ? Component.render() : react_1.default.createElement(Component, __assign({}, this.componentProps))
                        });
                        return [3 /*break*/, 5];
                    case 1:
    ...
    RouterOutlet.prototype.render = function () {
        return (react_1.default.createElement(EasyrouteContext.Provider, { value: { router: this.router, nestingDepth: this.nestingDepth + 1 } },
            react_1.default.createElement("div", { className: "easyroute-outlet" + (this.state.transitionClassName ? ' ' + this.state.transitionClassName : '') }, this.state.component)));
    };
    return RouterOutlet;
}(react_1.Component));
