...
var RouterOutlet = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        e_1 = _d.sent();
                        this.setState({
                            component: "[Easyroute] Error changing component: " + e_1.message
                        });
                        return [3 /*break*/, 5];
    ...
    RouterOutlet.prototype.render = function () {
        return (react_1.default.createElement(EasyrouteContext.Provider, { value: { router: this.router, nestingDepth: this.nestingDepth + 1 } },
            react_1.default.createElement("div", { className: "easyroute-outlet" + this.className + (this.state.transitionClassName ? ' ' + this.state.transitionClassName : '') }, this.state.component)));
    };
    return RouterOutlet;
}(react_1.Component));
